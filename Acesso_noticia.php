...
<div class="row noticia-post-full d-flex">
  <div class="col-md-77 noticia-post-img-full">
    <?php echo '<img id="img_acesso_full" class=" mx-auto-2" width="88%" height="88%" src="./imagens_noticias/'.$linha['nome_capa'].'" role="img" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" /></img>';?>
  </div>
