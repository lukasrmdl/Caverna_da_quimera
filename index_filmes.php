...
?>
    <section>
        <form form="mostra_noticia">
            ...
            <button onclick="window.location.href = 'http://localhost/caverna_da_quimera/Acesso_noticia.php?acessa_noticia=<?php echo $linha['idnoticia']?>'" form="mostra_noticia" type="submit" name="botao" value="Acessar" >Acessar</button></form>
    </section>
</body>
<?php
}
