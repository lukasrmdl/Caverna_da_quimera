...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Set-2022 às 17:59
...
--
-- Banco de dados: `projeto_final_banco`
--
...
CREATE TABLE `noticias` (
  ...
  `nome_capa` varchar(40) DEFAULT NULL,
  `texto` text NOT NULL,
...
INSERT INTO `noticias` (`idnoticia`, `nome`, `sobrenome`, `email`, `titulo`, `subtitulo`, `capa`, `nome_capa`, `texto`, `ver`, `data`, `nomecategoria`) VALUES
(3, 'Eduardo', 'Lima', 'Eduardo.mdl@hotmail.com', 'Constantine 2 está em produção na WB e terá o retorno de Keanu Reeves', 'Primeiro filme foi lançado em 2005', 'constantine-novo-filme.jpg', 'constantine-novo-filme.jpg', '17 anos depois do primeiro filme, Constantine está de volta nas telonas. De acordo com o Deadline, a Warner Bros. deu sinal verde para a sequência do filme. Keanu Reeves, que viveu o perspnagem em 2005, vai reprisar o papel do exorcista.\r\n\r\nOutro retorno garantido é do diretor Francis Lawrence, com Akiva Goldsman na função de roteirista, que terá produção da Bad Robot de J.J. Abrams e do próprio Goldsman.\r\n\r\nConstantine arrecadou mais de US$ 200 milhões em bilheteria no ano de 2005. Desde então, os fãs há muito tempo estão ansiosos por uma sequência.\r\n\r\nBaseado na história em quadrinhos Hellblazer da DC Comics, criada por Alan Moore, Stephen R. Bissette e John Ridgway e escrita por Jamie Delano e Garth Ennis (entre outros escritores), a adaptação cinematográfica de 2005 segue John Constantine (Keanu Reeves), um exorcista sobrenatural cínico e demonologista com a habilidade de perceber e se comunicar com meio-anjos e meio-demônios em sua verdadeira forma. Constantine, que busca a salvação da condenação eterna no Inferno por uma tentativa de suicídio em sua juventude, exorciza demônios de volta ao Inferno para ganhar o favor do Céu, mas se cansa com o tempo. Ele eventualmente ajuda um detetive de polícia (Rachel Weisz) a provar que a morte de sua irmã não foi um suicídio, ao mesmo tempo desvendando um enredo muito maior e mais sombrio.', 'off', '2022-09-21', 'Filmes'),
(4, 'Eduardo', 'Silva', 'Eduardo.mdl@hotmail.com', 'Karatê Kid | Novo filme da franquia é anunciado para 2024', 'Novo filme é descrito como um retorno da franquia original', 'karate-kid.png', 'karate-kid.png', 'E quando ninguém esperava, a Sony Pictures anunciou que a franquia Karatê Kid está de volta para as telonas. O estúdio o novo filme para 07 de junho de 2024. As informações são da Variety.\r\n\r\nA Sony está encarando o novo filme como “retorno da franquia original”. Ou seja, é esperado que o elenco original, hoje na série Cobra Kai da Netflix, possa participar do filme.\r\n\r\nKaratê Kid ganhou quatro filmes da história original e um reboot em 2010 com Jackie Chan e Jaden Smith.\r\n\r\nO primeiro filme de Karatê Kid foi lançado em 1984. A história acompanha o adolescente Daniel LaRusso se envolve com a ex-namorada do valentão da escola e começa a ser atormentado por sua gangue. Para sua sorte, ele conta com os ensinamentos do senhor Miyagi, um mestre de karatê que o prepara para autodefesa e também para um importante campeonato.\r\n\r\nDaniel LaRusso, Johnny Lawrence, rivais do primeiro filme, estão de volta no elenco da série Cobra Kai. Outros personagens dos filmes também retornaram. A quinta temporada da série estreou em 09 de setembro na Netflix. Na trama, anos depois de perder o grande torneio de caratê, Johnny Lawrence busca dar um novo significado para sua vida e abre o dojô Cobra Kai. Com isso, ele acaba reacendendo sua antiga rivalidade com Daniel LaRusso.', 'off', '2022-09-21', 'Filmes'),
(5, 'Eduardo', 'Silva', 'Eduardo.mdl@hotmail.com', 'Gran Turismo | Filme que adapta o game será estrelado por David Harbour', 'Filme será dirigido por Neill Blomkamp', 'david-harbour-gran-turismo.jpg', 'david-harbour-gran-turismo.jpg', 'Gran Turismo, popular franquia de jogos de corrida, vai ganhar filme e já tem seu protagonista. De acordo com o Hollywood Reporter, David Harbour (Stranger Things, Viúva Negra) será a estrela do longa.\r\n\r\nHarbour vai estrelar o filme como um piloto aposentado que ajuda a ensinar um adolescente com sonhos de dirigir enquanto ele entra em uma série de competições da Nissan a caminho de se tornar um verdadeiro piloto profissional de corrida.\r\n\r\nGran Turismo será dirigido por Neill Blomkamp, conhecido pelos filmes Distrito 9 (2009), Elysium (2013) e Chappie (2015). O roteiro é assinado pela dupla Jason Hall (Sniper Americano) e Zach Baylin (King Richard: Criando Campeãs). O longa tem estreia prevista para 11 de agosto de 2023.\r\n\r\n“Como uma das franquias mais antigas e amadas da PlayStation, é ótimo fazer parceria com a Columbia Pictures novamente para dar vida ao Gran Turismo de uma maneira emocionante”, disse Asad Qizilbash, da PlayStation Productions, em comunicado. “Mal podemos esperar para que o público veja a visão de Neill desta inspiradora história verdadeira de jogador que se tornou piloto profissional de corridas.”\r\n\r\nOriginalmente lançada em 1997, a franquia Gran Turismo se tornou um dos jogos de corrida mais populares de todos os tempos. Gran Turismo 7 é o jogo mais recente da franquia, lançado no PlayStation 4 e PlayStation 5 em março deste ano.\r\n\r\nDavid Harbour também foi anunciado no fim de semana para o elenco de Thunderbolts, filme que reúne os anti-heróis do MCU.', 'off', '2022-09-21', 'Filmes'),
(6, 'Eduardo', 'Silva', 'Eduardo.mdl@hotmail.com', 'Babilônia | Com Brad Pitt e Margot Robbie, filme de Damien Chazelle ganha trailer eletrizante', 'Novo filme de Damien Chazelle, vencedor do Oscar, estreia em janeiro de 2023.', 'Babilonia.jpg', 'Babilonia.jpg', 'A Paramout Pictures divulgou o trailer de Babilônia, filme dirigido pelo vencedor do Oscar Damien Chazelle (La La Land), e estrelado por Brad Pitt, Margot Robbie, Diego Calva, Tobey Maguire, Jean Smart, Jovan Adepo e Li Jun Li. \r\n\r\nSobre o filme\r\nBabilônia é um filme de época que se passa em Los Angeles na década de 1920. A narrativa traz uma história de ambição e excessos desmedidos, acompanhando a ascensão e a queda dos personagens durante uma era de decadência desenfreada e depravação em uma jovem Hollywood.\r\n\r\nEscrito e dirigido por Damien Chazelle, o filme é uma produção da Paramount Pictures e parceria com Marc Platt, Wild Chickens e Organism Pictures Production. O ator Tobey Maguire, junto com Michael Beugg, Wyck Godfrey, Helen Estabrook e Adam Siegel, assina a produção executiva do longa.\r\n\r\nBabilônia estreia 19 janeiro de 2023 nos cinemas.', 'off', '2022-09-21', 'Filmes'),
(9, 'Eduardo', 'Silva', 'Eduardo.mdl@hotmail.com', 'A Menina Que Matou Os Pais – A Confissão ganha primeiras imagens', 'Filme vai mostrar os bastidores da investigação do Caso Richthofen', 'download.jpg', 'download.jpg', 'A Galeria Distribuidora e a Santa Rita Filmes divulgaram as primeiras imagens oficiais de A Menina Que Matou Os Pais – A Confissão, terceiro filme do Caso Richthofen.\r\n\r\nA história começa no mesmo ponto em que os filmes anteriores terminam e traz os bastidores da investigação. Com direção de Mauricio Eça e roteiro de Ilana Casoy e Raphael Montes, o longa traz novamente Carla Diaz, Leonardo Bittencourt, Allan Souza Lima, Kauan Ceglio, Augusto Madeira, Débora Duboc, Gabi Lopes e apresenta, entre outros, os atores Bárbara Colen, Arthur Kohl, Adriano Bolshi, Che Moais, Fernanda Marques e Daniel Alvim.\r\n\r\nO diretor do filme comenta: “Confissão é um filme direto e cru, um thriller psicológico que você já sabe como acaba, mas não imagina como tudo aconteceu. Se passa durante 8 dias muito intensos onde as verdades de cada personagem vão vindo à tona”.\r\n\r\nA Menina que Matou os Pais e O Menino que Matou meus Pais estrearam em setembro de 2021 no Prime Video.\r\n\r\nA história situada no ano de 2002 acompanha o casal de namorados Suzane von Richthofen (Carla Diaz) e Daniel Cravinhos (Leonardo Bittencourt) declarando-se culpados pelo assassinato dos pais de Suzane. Ao longo do julgamento deles, ambos deram versões diferentes sobre o crime que, à época, teve grande repercussão e gerou indignação da população. No filme A Menina que Matou os Pais a narrativa é baseada no olhar de Daniel Cravinhos a respeito do crime. Em O Menino que Matou meus Pais, a narrativa é baseada no olhar de Suzane von Richthofen a respeito do crime', 'off', '2022-09-21', 'Filmes'),
(10, 'Eduardo', 'Silva', 'Eduardo.mdl@hotmail.com', 'Jacob Elordi será Elvis Presley no novo filme de Sofia Coppola', 'Filme será inspirado nas memórias de Priscilla Presley, a esposa do Rei do Rock', 'jacob_elordi_elvis.jpg', 'jacob_elordi_elvis.jpg', 'Elvis Presley voltará a aparecer nos cinemas. Depois do sucesso Elvis, agora será a vez do Rei do Rock ganhou um novo filme, mas sob uma ótima diferente. De acordo com o Deadline, Sofia Coppola vai comandar o longa-metragem Priscilla, adaptação do livro de memórias Elvis and Me de Priscilla Beaulieu Presley.\r\n\r\nCailee Spaeny (Mare of Easttown) e Jacob Elordi (Euphoria) foram escalados para interpretar Priscilla e Elvis Presley, respectivamente . Publicado em 1985, o relato íntimo de Priscilla sobre sua vida com Elvis se tornou um best-seller do New York Times e uma sensação internacional. Coppola também adaptou o roteiro.\r\n\r\nPriscilla ainda não tem previsão de estreia.', 'off', '2022-09-21', 'Filmes'),
(15, 'Matheus', 'Ferraz', 'Matheus.f101@hotmail.com', 'Sr. & Sra. Smith | Wagner Moura entra para o elenco da série', 'Donald Glover e Maya Erskine serão os protagonistas da série', 'wagner-moura-sr-sra-smith-750x375.jpg', 'wagner-moura-sr-sra-smith-750x375.jpg', 'Segundo informações da Variety, o brasileiro Wagner Moura (Shining Girls) entrou para o elenco de Sr. e Sra. Smith, série do Prime Video que adapta o filme de 2005 dirigido por Doug Liman.\r\n\r\nAlém de Moura, Parker Posey também está no elenco junto com John Turturro, Paul Dano e Michaela Coel.\r\n\r\nDonald Glover e Maya Erskine serão os protagonistas da série. A história original foi estrelada pelos vencedores do Oscar Angelina Jolie e Brad Pitt. Na trama, John (Brad Pitt) e Jane Smith (Angelina Jolie) aparentemente parecem formar um casal normal, mas na realidade ambos mantêm um segredo. Os dois são assassinos de aluguel contratados por empresas rivais. A verdade só vem à tona quando John e Jane, sem saber, recebem uma missão para eliminar o mesmo alvo e mais tarde descobrem que devem matar um ao outro.\r\n\r\nSr. e Sra. Smith tem Glover e Francesca Sloane como showrunners. O projeto fará parte do acordo geral de Glover com a Amazon Studios.\r\n\r\nDonald Glover ficou conhecido pelos trabalhos nas séries Community e Atlanta. No cinema, ele interpretou a versão jovem de Lando em Han Solo: Uma História Star Wars. Ele também foi voz de Simba no live-action de O Rei Leão.\r\n\r\nOs produtores executivos são Yariv Milchan e Michael Schaefer, da New Regency, e Jenny Robins, da Wells Street Films. Essa novidade está programada para estrear no Prime Video.', 'off', '2022-09-23', 'Séries'),
(16, 'Lukas', 'Raphael', 'lukas.rmdl@gmail.com', 'GTA VI | Rockstar se manifesta sobre vazamento do game', 'Vários vídeos e imagens do jogo vazaram na internet', 'gta-vazamento-750x375.jpg', 'gta-vazamento-750x375.jpg', 'GTA VI foi finalmente mostrado ao mundo, mas não da maneira que a Rockstar Games gostaria. Vários vídeos e imagens do jogo vazaram na internet, mostrando a tão esperada sequência em uma forma inacabada. Insatisfeita com o vazamento, a Rockstar emitiu uma declaração confirmando que era realmente o novo game em desenvolvimento.\r\n\r\n“Estamos realmente desapontados por ter quaisquer detalhes do nosso próximo jogo compartilhado com todos vocês dessa maneira. Nosso trabalho no próximo jogo Grand Theft Auto continuará conforme planejado e continuamos comprometidos como sempre em oferecer uma experiência para vocês, nossos jogadores, que realmente exceda suas expectativas. Atualizaremos todos novamente em breve e, é claro, apresentaremos este jogo adequadamente quando ele estiver pronto. Queremos agradecer a todos por seu apoio contínuo nessa situação” foi o que declarou a empresa sobre o ocorrido.\r\n\r\nGrand Theft Auto (ou GTA) é uma série de jogos criada por David Jones, e Mike Dailly, e posteriormente pelos irmãos Dan e Sam Houser, Leslie Benzies e Aaron Garbut. A série é focada em cidades fictícias dominadas pelo crime e pelas gangues de rua, fortemente modeladas com base em grandes metrópoles, principalmente dos Estados Unidos, mas com passagens também pela Inglaterra.\r\n\r\nOs jogos da série são em mundo aberto e o personagem jogável (um criminoso, protagonista de um enredo repleto de atividades ilegais, como violência, tráfico de drogas, assassinato, prostituição etc.) pode cumprir missões para o progresso da história, bem como participar de ações não lineares, todas consistindo de ação, aventura, condução, RPG, corridas, entre outros.\r\n\r\nGTA V foi o último título da série, lançado originalmente em 17 de setembro de 2013 para PlayStation 4, Xbox One, PlayStation 3, Xbox 360, Microsoft Windows.', 'off', '2022-09-23', 'Games'),
(17, 'manuela', 'salabelly', 'manu.belly@hotmail.com', 'Tartarugas Ninja: Coleção Clássica Vol. 5', 'Coleção reúne o último arco de histórias escrito pelos criadores Kevin Eastman e Peter Laird', 'tartarugas-vol-5-ler.jpg', 'tartarugas-vol-5-ler.jpg', 'Tartarugas Ninja: Coleção Clássica Vol. 5, da editora Pipoca & Nanquim, reúne as edições 56-62 de Teenage Mutant Ninja Turtles, produzidas pelo Mirage Studios, com o último arco de histórias escrito pelos criadores Kevin Eastman e Peter Laird.\r\n\r\nÉ notório perceber a pouca presença de Kevin Eastman e Peter Laird neste arco. Ambos decidiram focar nas questões comerciais da franquia, naquela época já com filmes, série animada e games em desenvolvimento. Portanto, o leitor se depara com histórias mais soturnas, mais íntimas sobre os personagens. Faltou aquela leveza nas primeiras histórias, o que pode incomodar alguns leitores.\r\n\r\nContudo, Tartarugas Ninja: Coleção Clássica Vol. 5 apresenta os heróis sozinhos e precisando lidar de uma vez por todas com o Clã do Pé assolando Nova York. Enquanto isso, Mestre Splinter segue isolado e ferido nos esgotos enfrentando o Rei Rato. Já April O’Neil e Casey Jones sofrem perdas drásticas que o fazem repensar toda sua trajetória.\r\n\r\nO vol. 5 apresenta Kirai, uma guerreira misteriosa do Japão que propõe uma parceria para Leonardo, Rafael, Donatello e Michelangelo, que seguem desconfiados.\r\n\r\nO arco envolvendo Casey Jones é o grande destaque desse volume, com o leitor sendo apresentado por um lado nunca antes visto do personagem. Os arcos de April e Splinter seguem arrastados e que pouco acrescentam à narrativa. Já com as Tartarugas, é interessante notar o quanto evoluíram com os anos de treinamento e que estão prontos para proteger Nova York.\r\n\r\nTartarugas Ninja: Coleção Clássica Vol. 5 prepara o terreno para encerramento das histórias originais dos quelônios. Vem sendo uma experiência única acompanhar todos os arcos desses personagens tão marcantes na cultura pop.', 'off', '2022-09-23', 'Quadrinhos'),
(20, 'Maria', 'Quintana', 'maria.quin@gmail.com', 'Evan Peters vive o serial killer Jeffrey Dahmer em nova série da Netflix', 'O ator que conquistou a todos em American Horror Story promete impressionar novamente com esse papel', 'Dahmer.jpg', 'Dahmer.jpg', 'A Netflix divulgou o trailer de Dahmer: Um Canibal Americano, sua nova minissérie produzida por Ryan Murphy e Ian Brennan que estrela Evan Peters (American Horror Story) como o serial killer Jeffrey Dahmer.\r\n\r\nNas décadas de 1970 e 80, Jeffrey Dahmer drogou, abusou sexualmente, matou e chegou a comer partes dos corpos de 17 rapazes, vítimas que assumiu assassinar por prazer.\r\n\r\nDo vencedor do Emmy e criador de “American Crime Story”, a série “Dahmer: Um Canibal Americano” analisa os crimes terríveis cometidos por Jeffrey Dahmer e os problemas sistêmicos que permitiram que um dos maiores serial killers dos Estados Unidos continuasse agindo com total impunidade ao longo de mais de uma década.\r\n\r\nCom estreia em 21 de setembro, o elenco também conta com Richard Jenkins (Lionel Dahmer), Molly Ringwald (Shari Dahmer), Michael Learned (Catherine Dahmer), e Niecy Nash (Glenda Cleveland).', 'off', '2022-09-23', 'Séries'),
(23, 'Lukas', 'Raphael', 'lukas.rmdl@gmail.com', 'God of War: Ragnarok ganha novo trailer com luta contra Thor', 'Kratos encara o Deus do Trovão', 'god-of-war.jpg', 'god-of-war.jpg', 'A Santa Monica Studio divulgou no State of Play o novo trailer de God of War: Ragnarok, a continuação dos eventos do game do ano de 2018. O vídeo mostra mais da cultura nórdica, com direito ao lobo Fenrir e termina com o aguardado embate entre Kratos e Thor, o Deus do Trovão.\r\n\r\nEm God of War: Ragnarok, Atreus anseia por conhecimento para ajudá-lo a entender a profecia de “Loki”, enquanto Kratos luta para se libertar do passado e ser o pai que seu filho precisa. O tempo todo, os olhos de Asgard observam todos os seus movimento.\r\n\r\nGod of War Ragnarok chegará para PS4 e PS5 em 09 de novembro de 2022.\r\n\r\nNo elogiado game de 2018, Kratos vive como um homem comum no reino dos monstros e deuses nórdicos. E é nesse mundo inóspito e implacável que ele precisa lutar para sobreviver… e ensinar seu filho a fazer o mesmo. Assumindo o papel de mentor e protetor de seu filho, Atreus, que está determinado a conquistar seu respeito, Kratos é forçado a lidar e controlar a fúria que, por muito tempo, foi sua essência, e a explorar um mundo extremamente perigoso com seu filho. Como mentor e protetor de um filho determinado a ganhar seu respeito, Kratos recebe a oportunidade inesperada de controlar sua raiva que há tanto tempo o define. Questionando a linhagem sombria que passou a seu filho, ele espera se redimir pelos erros do passado. Situado em florestas selvagens, montanhas e reinos da mitologia nórdica, God of War traz um novo universo distinto com seu próprio panteão de criaturas, monstros e deuses.', 'off', '2022-09-23', 'Games'),
(24, 'manuela', 'salabelly', 'manu.belly@hotmail.com', 'Autora brasileira lança fantasia publicada em oito países', 'Carolina Mulero lança O Grimório de Kala', 'unknown.png', 'unknown.png', 'Se você sente falta dos anos 90, aprecia um bom suspense e sabe reconhecer a magia das coisas simples, vai gostar de saber que a autora brasileira Carolina Mulero acabou de lançar uma obra inspirada em tudo isso e mais um pouco.\r\n\r\nA fantasia acompanha a história de Kala, uma jovem bruxa que descobre uma conspiração em sua pequena cidade e precisa resolver um mistério para manter sua comunidade segura.\r\n\r\nO destaque da ficção vai para interpretação única de bruxaria que a autora propõe, em um universo que poderia muito bem ser como o nosso e onde a magia está nas pequenas atitudes e no instinto que cada mulher traz consigo. Muito além de feitiços e poções, a leitura traz uma reflexão sobre o efeito mágico do tempo, das relações e de saber apreciar a beleza do dia a dia.\r\n\r\nDivulgada em oito países como Canadá, Japão, Austrália e Estados Unidos, O Grimório de Kala prova que o Brasil pode – e deve – estar cada vez mais presente no universo da fantasia literária e apesar de ser a primeira obra da autora, demonstra a maturidade de alguém que colocou sua própria história e essência nas páginas de um livro.\r\n\r\nAgora, a luta é para que o conteúdo seja divulgado e alcance o reconhecimento necessário para ser traduzido também em outras línguas. Nada que um pouco de magia não consiga fazer! O Grimório de Kala está presente nas principais plataformas de compras online como Amazon, Carrefour, Extra, Submarino e Shoptime. Além disso, você pode seguir a autora @carolmulero e acompanhar os próximos passos dessa jornada.', 'off', '2022-09-23', 'Livros'),
(25, 'manuela', 'salabelly', 'manu.belly@hotmail.com', 'A Filha das Profundezas, de Rick Riordan', 'Uma breve explicação sobre um livro que vai despertar seu leitor interior.', 'unknown2.png', 'unknown2.png', 'Quando Rick Riordan anunciou seu mais novo sucesso literário, os fãs logo se animaram com a possibilidade de mais uma história da franquia Percy Jackson chegar por aí. Não chegou, mas nada que diminua toda a atenção que A Filha das Profundezas deve receber. E para os nostálgicos de plantão, há uma primeira grande semelhança entre a protagonista e o filho de Poseidon: Ana Dakkar é a última descendente viva de um verdadeiro gênio dos mares (infelizmente, ele não era imortal como o pai de Percy).\r\n\r\nA história de A Filha das Profundezas:\r\nPela primeira vez nos livros de Rick Riordan temos uma protagonista feminina (YAY!). Depois de conhecermos Percy, Magnus, Jason e Lester, Ana Dakkar chegou para mostrar que heróis independem de gênero (e acreditem, ela é uma das melhores protagonistas de Riordan até agora). Lidando com os problemas que uma adolescente de sua idade precisa lidar, como cólicas menstruais e absorventes em um submarino pré-histórico, ela enfrentará alguns dos típicos desafios que uma heroína precisa vencer, mas felizmente, ela terá os melhores amigos possíveis para isso.\r\n\r\nAna é uma estudante da renomada Academia Harding-Pencroft, conhecida popularmente como Academia HP (e sim, Rick Riordan faz questão de deixar claro estar ciente das comparações com Harry Potter. Em A Filha das Profundezas, descobrimos que lá estudam os melhores cientistas marinhos, guerreiros navais, navegadores e exploradores submarinos do mundo. Assim como na escola do menino bruxo, os alunos são desenvolvidos em quatro casas: Golfinhos, Orcas, Tubarões e Cefalópodes, cada qual escolhida de acordo com as características de cada um.\r\nA herdeira de Nemo:\r\nNão, não estamos falando do peixe, mas sim do lendário Capitão Nemo das histórias de Julio Verne. A Filha das Profundezas é todo baseado em A Ilha Misteriosa e Vinte Mil Léguas Submarinas, e tal como em Percy Jackson, traz para o público histórias dos livros que realmente aconteceram na vida real. A família de Ana é atualmente resumida em seu irmão mais velho Dev, pois seus pais morreram em uma expedição científica anos antes, quando trabalhavam na HP.\r\n\r\nQuando uma tragédia acontece na escola e muda a vida de Ana e seus amigos para sempre, ela descobre que o Instituto Land, uma escola rival, está disposta a tudo para destruir a HP e tudo aquilo que ela prega. E o principal: Ana Dakkar precisa ser capturada viva, pois é a última descendente viva de Nemo, conhecido como Príncipe Dakkar.\r\n\r\nMotivos para ler:\r\nA escrita de Rick Riordan não mudou, para a alegria dos fãs. O autor recorre a todos os elementos que o consagraram como um dos maiores escritores infantojuvenil da atual geração, trazendo uma linguagem moderna e fácil, dialogando com o público a cada página. As referências clássicas a cultura pop também estão presentes, como Harry Potter, Adele e muitas outras que deixaremos você descobrir sozinhe! A Filha das Profundezas conta com uma trama rápida, intrigante e coesa, amarrando pontas a cada capítulo e deixando ganchos para uma possível continuação.\r\n\r\nAlém de Ana, a história também se desenrola graças aos personagens coadjuvantes, tão bons quanto a protagonista. Gemini Twain é claramente um interesse amoroso futuro de Ana, mas por enquanto, é um ótimo amigo e um fiel companheiro de escola. Nelinha da Silva chega como a primeira personagem brasileira de extrema importância nas histórias de Riordan e sua perspicácia e inteligência evitam que Ana vá parar no fundo do mar diversas vezes.\r\nAinda não sabemos se A Filha das Profundezas ganhará uma continuação, mas Riordan dificilmente investirá em um único livro em sua mais nova história. O autor já revelou a importância da inspiração em Julio Verne, um de seus autores favoritos, algo que pode trazer para a possível nova saga um carinho ainda mais especial.\r\n\r\nNo Brasil, o livro foi publicado pela Editora Intrínseca.\r\n', 'off', '2022-09-23', 'Livros'),
(26, 'Valentina ', 'Carla', 'carla.valentina@gmail.com', 'Escuridão, de David Small', 'Um retorno triunfal do autor de Cicatrizes', 'escuridao-hq.png', 'escuridao-hq.png', 'Escuridão é a mais nova graphic novel de David Small (Cicatrizes) após um longo hiato. Lançado no Brasil pela Darkside Books, a obra ficcional tem um quê de O Senhor das Moscas e O Apanhador no Campo de Centeio.\r\n\r\nEscuridão é situada na década de 50 e conta a jornada do adolescente Russell Pruitt, que vê sua mãe deixando ele e o pai alcoólatra para trás. Sem muito o que fazer, os dois decidem se mudar de Ohio para Califórnia, dormindo de hotel em hotel até se estabelecerem na cidade de Marsfield, vivendo na pensão administrada por um casal de chineses.\r\n\r\nA cidade é assombrada por um assassino de animais e um grupo de garotos que passam a perseguir Russell, que ainda está digerindo a reviravolta que sua vida tomou após o abandono da mãe. Russell está sozinho e precisa amadurecer de forma prematura.\r\n\r\nCom mais de 400 páginas, Escuridão tem um traço simples em forma de rabisco, mas sempre destacando o semblante perdido do inocente Russell. Sua jornada na história deixa um nó na garganta sobre a avalanche que sua vida tomou. Ele não tem ninguém para dialogar, já que pai está perdido depois da separação.\r\n\r\nO garoto até encontra um certo amparo, mas como o próprio título da obra diz, sua história está cercada pela escuridão.\r\n\r\nPor fim, Escuridão é uma obra com muitas temas atuais como masculinidade tóxica, bullying e homofobia. Um retorno triunfal de David Small.', 'off', '2022-09-23', 'Quadrinhos');
...
CREATE TABLE `redator` (
  ...
  `email_redator` varchar(40) DEFAULT NULL,
  `senha_redator` varchar(255) DEFAULT NULL,
  `foto_redator` varchar(100) DEFAULT NULL,
...
INSERT INTO `redator` (`id_redator`, `nome_redator`, `email_redator`, `senha_redator`, `foto_redator`, `tipousuario`, `status`) VALUES
(20, 'lukarte', 'lukas.rmdl@gmail.com', '$2y$10$C4OfHiH.pTT6VfDUS/VP3O1dFfyR96URERvk5mQrB4zabos9HASA.', 'eu a ludovica.png', 2, 1),
(23, 'Valentina', 'cairollivalentina@gmail.com', '$2y$10$oYNddL87RMgUD2sOads4iOJ.XcEBCwQkdrGXw4I1wvh8iQFVzo6u.', 'elisa.png', 2, 1),
(24, 'luna', 'lunalovegood119@gmail.com', '$2y$10$K5gnusFF10tmvb5EkTbpNOCPjeqad7ZWlgkwEZEVSr/reh.olOaMO', 'elisa.png', 2, 0),
(25, 'imprimi', 'teste.rmdl@gmail.com', '$2y$10$Q81vrXm3idgycSv00r56y..lcCwqy5v04FRRvKVQdYPnl6LaaGyjO', 'DbP0Cd8U0AEpB2I (1).jpg', 2, 1),
(26, 'iago', 'itachi@uchiha.com', '$2y$10$rpiGh2lJiJrWwtUElMaauesq8zE9M.Q54lpcxoezMtol2FHxApmjm', 'DbP0Cd8U0AEpB2I (1).jpg', 2, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `suporte_envios`
--
...
CREATE TABLE `suporte_envios` (
  ...
  `email_usuario` varchar(140) DEFAULT NULL,
  `endereco_usuario` varchar(80) NOT NULL,
  `logradouro_usuario` varchar(140) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `suporte_envios`
--

INSERT INTO `suporte_envios` (`id_envio`, `nome_usuario`, `sobrenome_usuario`, `email_usuario`, `endereco_usuario`, `logradouro_usuario`, `estado_usuario`, `cidade_usuario`, `cep_usuario`, `erro_assunto`, `erro_descricao`) VALUES
(1, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Pelotas', '96070620', 'lentidao', 'demora para carregar as noticias'),
(2, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Acegua', '96070620', 'css', 'aaaaaaaaaa'),
(3, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Agudo', '96070620', 'funcionalidade', 'aaaaaaaaaaaaaaaaaaa'),
(4, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Alto Alegre', '96070620', 'css', 'aaaaaaaaaaaaaaaa'),
(5, 'aaaaa', 'aaaaaaa', '', 'aaa', 'aaa', '15', 'Areia de Barauna', 'aaaa', 'outros', 'aa'),
(6, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Alto da Uniao', '96070620', 'lentidao', 'aaaaaaaaaaaaaaaaaaaaaa'),
(7, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmuth hardt', 'Sítio Floresta', '23', 'Afonso Rodrigues', '96070620', 'css', 'aaaaaaaaaaa'),
(8, 'lukas', 'raphael', 'lukas.rmdl@gmail.com', 'helmth hardt', '', '23', 'Pelotas', '546541561', 'funcionalidade', 'aaaaaaaaaaaa');
...
ALTER TABLE `noticias`
  ...
  ADD KEY `fk_categoria` (`nomecategoria`);
...
ALTER TABLE `redator`
  ...
  ADD UNIQUE KEY `email_redator` (`email_redator`);

--
-- Índices para tabela `suporte_envios`
--
ALTER TABLE `suporte_envios`
...
--
ALTER TABLE `redator`
  MODIFY `id_redator` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de tabela `suporte_envios`
--
ALTER TABLE `suporte_envios`
...
--
ALTER TABLE `noticias`
  ADD CONSTRAINT `fk_categoria` FOREIGN KEY (`nomecategoria`) REFERENCES `categorias` (`nome`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
